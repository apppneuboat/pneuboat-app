...
export default function MainApp() {
  ...
  // ✅ FIX PRINT iPad: petit délai + pas de scale transform
  const handlePrint = () => {
      ...
      <div className="pb-print-page">
        ...
        >
          ...
          <div className="pl-[16mm] flex flex-col h-full relative">
            ...
            {/* ✅ BODY BLOQUÉ A4 (ne grandit plus) */}
                      ...
                      {currentInvoice.items.map((it, i) => (
                        <tr key={it.id || i} className="align-top">
                          <td className="py-3 pr-3">
                            <div className="font-bold text-slate-900 pb-clamp-2">
                              {it.description || "—"}
                            </div>
            ...
            {/* FOOTER (en bas) */}
            <div className="pb-doc-footer border-t border-slate-200 px-8 py-5">
